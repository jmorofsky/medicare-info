        ...
        <div id='contact' className='contact'>
            <div style={{ overflow: 'hidden' }}>
                <svg
                    ...
                    style={{ fill: '#ffffff', width: '176%', height: 172, }}
                >
                    <path
            ...
            <div className='contact-container'>
                ...
                <div className='contact-info'>
                    <div className='hours'>
                        <h3 style={{ fontSize: '22px', color: '#212121', marginBottom: 0 }}>Office Hours</h3>
                        <p className='hoursText'>Monday - Friday: 8AM - 7PM ET</p>
                        <p className='hoursText'>Saturday - Sunday: 8AM - 2PM ET</p>
                    </div>

                    <div className='location'>
                        <h3 style={{ fontSize: '22px', color: '#212121', marginBottom: 0 }}>Contact Info</h3>
                        <p className='hoursText'><a href='tel:+19548496854' className='phone'
                            style={{ color: '#575757' }}>
                            ☎ (954) 849-6854
                        </a></p>
