    ...
    return (
        <div id='mission'>
            ...
            <q className='quote'>Trying to navigate the world of health insurance alone as a 65 year old can be a
                ...
                experience is as quick, easy, and painless as possible.</q>

            <div className='quoteContainer'>
                <img src={headshotSmall} alt='' className='headshotSmall'/>
                <div className='quotee'>
                    <p className='quoteeText' style={{fontSize: '16px'}}>Meghan Morofsky</p>
                    <p className='quoteeText' style={{fontSize: '13.5px'}}>Medicare Specialist</p>
                </div>
            </div>
        </div>
    )
